...
class AzureSynthesizer(BaseSynthesizer[AzureSynthesizerConfig]):
    ...
    def create_ssml(
        ...
        if self.synthesizer_config.azure_speaker_id:
            ...
            self.logger.error(f"The current voice is {voice} and voice name is {self.voice_name}")
            ...
            self.logger.error(f"The ssml root is {ssml_root} and tts_embedding is {tts_embedding}")
